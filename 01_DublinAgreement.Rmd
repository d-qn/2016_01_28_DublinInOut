...
for(lang in "IT") {  
  ...
  # plot chord diagram
  chord.out <- chorddiag(t(mat), groupnamePadding = groupnamePadding, groupnameFontsize = groupnameFontsize,
  ...
  swi_widget("chordDublin_outgoing_tmp.html", chord_outgoing.file,
    ...
    source = paste0(txt["source", lang], ": ", 
      ...
      " | code: ", htmlLink("https://github.com/mattflor/chorddiag", "chorddiagR")),
